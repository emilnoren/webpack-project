...
/***/ "./src/client/js/class-example.js":
/*!****************************************!*\
  !*** ./src/client/js/class-example.js ***!
  \****************************************/
/*! no static exports found */
...
/*#__PURE__*/
function () {
  function ClassExample(name) {
    (0, _classCallCheck2.default)(this, ClassExample);
    this.name = name;
  }

  (0, _createClass2.default)(ClassExample, [{
    key: "sayHi",
    value: function sayHi() {
      alert("Hi, ".concat(this.name));
    }
  }]);
  return ClassExample;
}();
...
/***/ "./src/client/js/function-example.js":
/*!*******************************************!*\
  !*** ./src/client/js/function-example.js ***!
  \*******************************************/
/*! no static exports found */
...
var _classExample = __webpack_require__(/*! ./js/class-example.js */ "./src/client/js/class-example.js");

var _functionExample = __webpack_require__(/*! ./js/function-example.js */ "./src/client/js/function-example.js");

// Import class ClassExample from class-example.js
// Create a new object of the class
var myClass = new _classExample.ClassExample('John Doe'); // Run the sayHi function of the object

myClass.sayHi(); // Import function hello from function-example.js

// Run imported function
console.log((0, _functionExample.hello)('World!')); // This fails because we didn't import the function
...
/***/ 0:
/*!**************************************************************!*\
  !*** multi ./src/client/main.js ./src/client/scss/main.scss ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/client/main.js */"./src/client/main.js");
module.exports = __webpack_require__(/*! ./src/client/scss/main.scss */"./src/client/scss/main.scss");
